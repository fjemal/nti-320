...
myusername="FdilJemal"                           # username
mynagiosserver="nagios2"                       # nagios server name
#mycactiserver="cacti-a"                         # cacti server name
myreposerver="rpm-3"                        # repo server
mynagiosserverip="35.197.66.103"                # ip address of your nagios server
...
gcloud compute scp builder-server:/home/fadil_jemal/builder-server.cfg /Users/Fadil/ --ssh-key-file=/Users/Jonathan/.ssh/google_compute_engine --zone us-west1-a
...
gcloud compute ssh fadil_jemal@nagios2 --zone us-west1-a --command "sudo /usr/sbin/nagios -v /etc/nagios/nagios.cfg" | grep "Things look okay - No serious problems"
