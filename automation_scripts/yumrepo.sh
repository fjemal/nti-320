...
gcloud compute scp ~/Desktop/net320/check_fjemal_plugin-1.0-1.el7.centos.x86_64.rpm \yumrepo:/home/fadil.jemal/ --ssh-key-file=/Users/fadil.jemal/.ssh/google_compute_engine --zone us-west1-a

mv check_fjemal_plugin-1.0-1.el7.centos.x86_64.rpm /repos/CentOS/7/x86_64/Packages/
